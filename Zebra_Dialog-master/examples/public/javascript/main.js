$(document).ready(function() {
    ...
    $('#cancelLayby').bind('click', function(e) {
        e.preventDefault();
        $.Zebra_Dialog('<strong>Note!</strong>,the layby will be completely removed from your account</br>', {
            'type':     'question',
            'title':    'Confirm Layby Cancellation',
            'buttons':  [
                {caption: 'Yes', callback: function() { submitform('cancelForm')}},
                {caption: 'No', callback: function() { alert('"No" was clicked')}},
                {caption: 'Cancel', callback: function() { alert('"Cancel" was clicked')}}
            ]
        });
