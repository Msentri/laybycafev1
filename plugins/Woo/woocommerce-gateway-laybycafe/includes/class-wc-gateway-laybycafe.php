...
class WC_Gateway_LaybyCafe extends WC_Payment_Gateway {
    ...
    public function __construct() {
        ...
        $this->url              = 'https://app.laybycafe.com/process';
        $this->validate_url     = 'https://app.laybycafe.com/process';
        ...
        if ( 'yes' === $this->get_option( 'testmode' ) ) {
            $this->url          = 'https://demo.laybycafe.com/process';
            $this->validate_url = 'https://demo.laybycafe.com/process';
