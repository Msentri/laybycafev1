...
if (strlen(@$title) > 20)
  $title = substr(filter_var(@$title, FILTER_SANITIZE_STRIPPED), 0, 20) . '...';

$seven_bit_msg = "Hey your oder ".@$product_ref." has been added successfully to the cart visit www.laybycafe.co.za/dashboard.php to view yor oder status";
