...
class Fnb
{
     ...
     */
    private $my_bank_accounts_url = "https://www.online.fnb.co.za/banking/Controller?nav=accounts.summaryofaccountbalances.navigator.SummaryOfAccountBalances&FARFN=4&actionchild=1&isTopMenu=true";
