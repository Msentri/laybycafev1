        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="alert alert-info alert-dismissible" role="alert">
                    ...
                    Please add the store name to create new laybys, click <a href="../../profile.php" class="alert-link">profile</a> to add a store
                </div>
                <?php }?>
                <h1>Dashboard</h1>
                <?php
				if(@$verifiedAccount == "N"){
					?>
                <div class="alert alert-danger" role="alert">An email Has been sent to the registered email account.
                  <br/>Please click on the link to verify account.
                </div>
                <?php
				}else{
                        ...
                        <div class="row">
                            <div class="col-md-12 pd-top">
                                <table class="table">
                                    ...
                                    <?php
										include 'functions/viewMerchant_dashboard.php'
										?>
                                    </tbody>
                                </table>
