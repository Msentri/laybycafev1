...
$options = array(
    'results_per_page' => 6,
    'url' => 'getConsumer_transaction.php?page=*VAR*&reference_number='.$reference_number.'&transaction_id='.$transaction_id.'',
    'db_handle' => $dbh
);
...
try
{
    $paginate = new pagination($page, "SELECT * FROM consumer_payments WHERE consumer_id='$reference_number' AND transaction_id='$transaction_id' ORDER BY id", $options);
}
